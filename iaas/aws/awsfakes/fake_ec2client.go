...
func (fake *FakeEC2Client) DescribeInstancesReturnsOnCall(i int, result1 *ec2.DescribeInstancesOutput, result2 error) {
	fake.DescribeInstancesStub = nil
...
func (fake *FakeEC2Client) DescribeInstanceStatusReturnsOnCall(i int, result1 *ec2.DescribeInstanceStatusOutput, result2 error) {
	fake.DescribeInstanceStatusStub = nil
...
func (fake *FakeEC2Client) AssociateAddressReturnsOnCall(i int, result1 *ec2.AssociateAddressOutput, result2 error) {
	fake.AssociateAddressStub = nil
...
func (fake *FakeEC2Client) TerminateInstancesReturnsOnCall(i int, result1 *ec2.TerminateInstancesOutput, result2 error) {
	fake.TerminateInstancesStub = nil
...
func (fake *FakeEC2Client) StopInstancesReturnsOnCall(i int, result1 *ec2.StopInstancesOutput, result2 error) {
	fake.StopInstancesStub = nil
...
func (fake *FakeEC2Client) StartInstancesReturnsOnCall(i int, result1 *ec2.StartInstancesOutput, result2 error) {
	fake.StartInstancesStub = nil
...
func (fake *FakeEC2Client) CreateTagsReturnsOnCall(i int, result1 *ec2.CreateTagsOutput, result2 error) {
	fake.CreateTagsStub = nil
...
func (fake *FakeEC2Client) RunInstancesReturnsOnCall(i int, result1 *ec2.Reservation, result2 error) {
	fake.RunInstancesStub = nil
...
var _ aws.EC2Client = new(FakeEC2Client)
